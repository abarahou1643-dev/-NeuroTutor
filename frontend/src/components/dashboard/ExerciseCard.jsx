// components/dashboard/ExerciseCard.jsx
...
const ExerciseCard = ({ exercise }) => {
  ...
  const difficulty = DIFFICULTY_LEVELS[exercise.difficulty] || DIFFICULTY_LEVELS.BEGINNER;
    ...
    <div className="bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow border border-gray-200">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:opacity-90 transition font-medium"
        >
